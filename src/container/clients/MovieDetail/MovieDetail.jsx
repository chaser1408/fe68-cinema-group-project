          ...
          <div className="container movie__detail__center">
            <div className="row movie__detail__infor"  >
              ...
              <i class="fa fa-heart text-danger"></i>
                <img src="data:image/png;base64," alt="" />
                <span className="percent text-white pl-2 font-weight-bold text-center">{movieDetail.danhGia}/10</span>
                <p>Tomatometer</p>
              </div>
        ...
        <div className="container mt-20">
          ...
          <Tabs tabPosition={'left'} className="bg-white px-5 py-5">
            {movieDetail.heThongRapChieu?.map((heThongRap, idx) => {
              return <TabPane tab={<div><img src={heThongRap.logo}
                width={50}
                height={50} alt={heThongRap.logo} />
                {heThongRap.tenHeThongRap}</div>}
                key={idx}>
